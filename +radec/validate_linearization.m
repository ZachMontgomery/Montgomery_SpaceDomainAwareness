function [ output_args ] = validate_linearization( x, simpar )
...
%% Calculate residual
z_tilde = radec.synthesize_measurement(x, simpar);
delz_nl = radec.compute_residual(x,xhat,z_tilde,simpar);
H = radec.compute_H(x,xhat, simpar);
